...
public class SendMailController {
	...
	public String success(@RequestParam("to") String to,
	...
	public String backFriday() {
		...
		String content = "<p>Xin chào,</p>"
				+ "<p>Cảm ơn bạn đã quan tâm đêns chương trình của cửa hàng chúng tôi !</p>"
		...
		msg.setText("Bạn đã đăng kí lịch thông báo chương trình Black Friday thành công ! (Bấm để xem chi tiết: https://countdown.onlinealarmkur.com/vi/)");
		javaMailSender.send(msg);
		System.out.println("ok");
